...
namespace Om.Orchard.SocialMetaTags {
    ...
    public class Migrations : DataMigrationImpl {
        #region Methods
        public int Create() {
            ContentDefinitionManager.AlterPartDefinition(typeof(AuthorshipMetaTagsPart).Name,
                cfg => cfg.Attachable()
            ...
            ContentDefinitionManager.AlterPartDefinition(typeof(SummaryCardsMetaTagsPart).Name,
                cfg => cfg.Attachable()
